...
pixi add netcdf-cxx4
# for installing globally
pixi global install netcdf-cxx4
```
...
It is possible to list all of the versions of `netcdf-cxx4` available on your platform:
...
```
pixi search netcdf-cxx4 --channel conda-forge
```
